...
from baru_ai.models.storyboard import (
    Storyboard,
    StoryboardFrame,
    StoryboardConfig,
    ContentMetadata,
...
class CustomPipeline(BasePipeline):
    ...
    Example usage:
        ...
        baru_ai.pipelines["my_custom"] = CustomPipeline(baru_ai)
    ...
    async def __call__(
        ...
        if tts_inference_mode:
            ...
            if tts_inference_mode == "local":
                ...
                final_voice_id = tts_voice or "en-US-AriaNeural"
            ...
            final_voice_id = voice_id or tts_voice or "en-US-AriaNeural"
            # tts_workflow already set from parameter
        ...
        from baru_ai.utils.os_util import (
        ...
        from baru_ai.utils.template_util import resolve_template_path, get_template_type
        ...
        from baru_ai.utils.content_generators import generate_title
        ...
        # from baru_ai.utils.content_generators import generate_narrations_from_topic
        ...
        if template_requires_image:
            ...
            from baru_ai.utils.content_generators import generate_image_prompts
            ...
            from baru_ai.utils.prompt_helper import build_image_prompt
...
# Use immediately
baru_ai.pipelines["quick"] = QuickPipeline(baru_ai)
result = await baru_ai.generate_video(text=content, pipeline="quick")
"""
