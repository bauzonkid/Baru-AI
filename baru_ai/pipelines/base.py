...
from baru_ai.models.storyboard import VideoGenerationResult
...
class BasePipeline(ABC):
    ...
    def __init__(self, baru_ai_core):
        ...
        Args:
            baru_ai_core: PixelleVideoCore instance (provides access to all services)
        """
        self.core = baru_ai_core
        
        # Quick access to services (convenience)
        self.llm = baru_ai_core.llm
        self.tts = baru_ai_core.tts
        self.media = baru_ai_core.media
        self.video = baru_ai_core.video
        
        # Backward compatibility alias
        self.image = baru_ai_core.media
