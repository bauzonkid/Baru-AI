...
Example:
    pipeline = AssetBasedPipeline(baru_ai)
...
class AssetBasedPipeline(LinearVideoPipeline):
    ...
    async def __call__(
        ...
        **kwargs
        ...
        """
        from baru_ai.pipelines.linear import PipelineContext
    ...
    async def generate_content(self, context: PipelineContext) -> PipelineContext:
        ...
        """
        from baru_ai.prompts.asset_script_generation import build_asset_script_prompt
    ...
    async def initialize_storyboard(self, context: PipelineContext) -> PipelineContext:
        ...
        context.config = StoryboardConfig(
            ...
            voice_id=context.params.get("voice_id") or context.params.get("tts_voice") or "en-US-AriaNeural",
