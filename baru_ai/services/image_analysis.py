...
class ImageAnalysisService(ComfyBaseService):
    ...
    Usage:
        ...
        description = await baru_ai.image_analysis("path/to/image.jpg")
        
        # Use local ComfyUI
        description = await baru_ai.image_analysis(
            "path/to/image.jpg",
            source="selfhost"
        )
        
        # List available workflows
        workflows = baru_ai.image_analysis.list_workflows()
    """
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            description = await baru_ai.image_analysis("temp/06.JPG")
