...
from baru_ai.models.storyboard import Storyboard, StoryboardFrame, StoryboardConfig, ContentMetadata
...
class PersistenceService:
    ...
    File structure:
        output/
        â””â”€â”€ {task_id}/
            â”œâ”€â”€ metadata.json          # Task metadata (input, result, config)
            â”œâ”€â”€ storyboard.json        # Storyboard data (frames, prompts)
            â”œâ”€â”€ final.mp4
            â””â”€â”€ frames/
                â”œâ”€â”€ 01_audio.mp3
                â”œâ”€â”€ 01_image.png
