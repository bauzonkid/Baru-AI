...
def get_baru_pixelle_root_path() -> str:
    """
    Get Pixelle-Video root path
    
    Uses baru_pixelle_ROOT environment variable to determine project root.
    ...
    env_root = os.environ.get("baru_pixelle_ROOT")
...
def ensure_baru_pixelle_root_path() -> str:
    """
    ...
    Returns:
        Root path as string
    """
    root_path = get_baru_pixelle_root_path()
...
def get_root_path(*paths: str) -> str:
    ...
    """
    root_path = ensure_baru_pixelle_root_path()
    if paths:
