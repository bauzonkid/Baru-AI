...
async def generate_title(
    ...
    from baru_pixelle.prompts import build_title_generation_prompt
...
async def generate_narrations_from_topic(
    ...
    """
    from baru_pixelle.prompts import build_topic_narration_prompt
...
async def generate_narrations_from_content(
    ...
    Returns:
        List of narration texts
    """
    from baru_pixelle.prompts import build_content_narration_prompt
...
async def generate_image_prompts(
    ...
    """
    from baru_pixelle.prompts import build_image_prompt_prompt
...
async def generate_video_prompts(
    ...
    """
    from baru_pixelle.prompts.video_generation import build_video_prompt_prompt
