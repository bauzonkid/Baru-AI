...
from baru_pixelle.utils.tts_util import edge_tts
from baru_pixelle.tts_voices import speed_to_rate
...
class TTSService(ComfyBaseService):
    ...
    Usage:
        ...
        audio_path = await baru_pixelle.tts(text="Hello, world!")
        
        # Use specific workflow
        audio_path = await baru_pixelle.tts(
            text="你好，世界！",
            workflow="tts_edge.json"
        )
        
        # List available workflows
        workflows = baru_pixelle.tts.list_workflows()
    """
