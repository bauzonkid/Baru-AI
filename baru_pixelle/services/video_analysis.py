...
class VideoAnalysisService(ComfyBaseService):
    ...
    Usage:
        ...
        description = await baru_pixelle.video_analysis("path/to/video.mp4")
        
        # Use local ComfyUI (future)
        description = await baru_pixelle.video_analysis(
            "path/to/video.mp4",
            source="selfhost"
        )
        
        # List available workflows
        workflows = baru_pixelle.video_analysis.list_workflows()
    """
    ...
    async def __call__(
        ...
        **params
        ...
        Examples:
            ...
            description = await baru_pixelle.video_analysis("temp/01_segment.mp4")
        ...
        """
        from baru_pixelle.utils.workflow_util import resolve_workflow_path
