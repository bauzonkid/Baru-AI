...
Example:
    pipeline = AssetBasedPipeline(baru_pixelle)
...
from baru_pixelle.pipelines.linear import LinearVideoPipeline, PipelineContext
...
class AssetBasedPipeline(LinearVideoPipeline):
    ...
    async def __call__(
        ...
        **kwargs
        ...
        """
        from baru_pixelle.pipelines.linear import PipelineContext
    ...
    async def generate_content(self, context: PipelineContext) -> PipelineContext:
        ...
        """
        from baru_pixelle.prompts.asset_script_generation import build_asset_script_prompt
