...
from baru_pixelle.models.storyboard import VideoGenerationResult
...
class BasePipeline(ABC):
    ...
    def __init__(self, baru_pixelle_core):
        """
        Initialize pipeline with core services
        
        Args:
            baru_pixelle_core: PixelleVideoCore instance (provides access to all services)
        """
        self.core = baru_pixelle_core
        
        # Quick access to services (convenience)
        self.llm = baru_pixelle_core.llm
        self.tts = baru_pixelle_core.tts
        self.media = baru_pixelle_core.media
        self.video = baru_pixelle_core.video
        
        # Backward compatibility alias
        self.image = baru_pixelle_core.media
