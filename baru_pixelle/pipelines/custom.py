...
from baru_pixelle.pipelines.base import BasePipeline
from baru_pixelle.models.progress import ProgressEvent
from baru_pixelle.models.storyboard import (
    Storyboard,
    StoryboardFrame,
    StoryboardConfig,
    ContentMetadata,
...
class CustomPipeline(BasePipeline):
    ...
    Example usage:
        ...
        baru_pixelle.pipelines["my_custom"] = CustomPipeline(baru_pixelle)
    ...
    async def __call__(
        ...
        from baru_pixelle.utils.os_util import (
        ...
        from baru_pixelle.utils.template_util import resolve_template_path, get_template_type
        ...
        from baru_pixelle.utils.content_generators import generate_title
        ...
        # from baru_pixelle.utils.content_generators import generate_narrations_from_topic
        ...
        if template_requires_image:
            ...
            from baru_pixelle.utils.content_generators import generate_image_prompts
            ...
            from baru_pixelle.utils.prompt_helper import build_image_prompt
...
# Use immediately
baru_pixelle.pipelines["quick"] = QuickPipeline(baru_pixelle)
result = await baru_pixelle.generate_video(text=content, pipeline="quick")
"""
