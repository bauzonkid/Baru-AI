...
from baru_pixelle.services.llm_service import LLMService
from baru_pixelle.services.tts_service import TTSService
from baru_pixelle.services.media import MediaService
from baru_pixelle.services.image_analysis import ImageAnalysisService
from baru_pixelle.services.video_analysis import VideoAnalysisService
from baru_pixelle.services.video import VideoService
from baru_pixelle.services.frame_processor import FrameProcessor
from baru_pixelle.services.persistence import PersistenceService
from baru_pixelle.services.history_manager import HistoryManager
from baru_pixelle.pipelines.standard import StandardPipeline
from baru_pixelle.pipelines.custom import CustomPipeline
from baru_pixelle.pipelines.asset_based import AssetBasedPipeline
...
class PixelleVideoCore:
    ...
    Usage:
        ...
        media = await baru_pixelle.media(prompt="a cat")
        
        # Check active capabilities
        print(f"Using LLM: {baru_pixelle.llm.active}")
        print(f"Available TTS: {baru_pixelle.tts.available}")
